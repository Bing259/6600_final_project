...
The goal of this project is to evaluate how modern deep learning models and traditional models perform on this difficult task. We begin by focusing on two types of neural models. The first is a bidirectional LSTM, which processes text as a sequence and learns patterns based on word order. The second is BERT, a transformer-based model that captures contextual relations between all words in a sentence. We also compare both models with a Naive Bayes model to illustrate the gap between simple bag-of-words-based methods and contextual models. 
...
- Do contextual models like BERT offer an advantage over sequence models like LSTM?
